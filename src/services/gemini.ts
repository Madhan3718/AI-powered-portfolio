...
- Data Applications Engineer with experience in data engineering and analytics in the real estate domain. Specialized in ERP data extraction, advanced SQL development, Power BI dashboards, GCP-based data pipelines, and data reconciliation. Proven impact on operational efficiency by reducing manual reporting by 70% and increasing stakeholder data adoption by 50%.
