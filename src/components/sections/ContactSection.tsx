  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 space-y-6">
      ...
      <div className="text-center mb-6">
        ...
        <h2 className="text-4xl font-black bg-gradient-to-r from-pink-400 via-purple-400 to-purple-600 bg-clip-text text-transparent mb-4 tracking-tight">Let's Connect!</h2>
      </div>
